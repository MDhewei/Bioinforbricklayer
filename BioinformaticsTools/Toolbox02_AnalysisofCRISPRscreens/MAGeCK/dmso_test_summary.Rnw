...
library(xtable)
comparisons=c("3,4,5_vs_2 neg.","3,4,5_vs_2 pos.");
ngenes=c(1118,1118);
...
\newpage\section{Comparison results of 3,4,5 vs 2 neg.}

The following figure shows the distribution of RRA score in the comparison 3,4,5 vs 2 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of 3,4,5 vs 2 pos.}

The following figure shows the distribution of RRA score in the comparison 3,4,5 vs 2 pos., and the RRA scores of 10 genes.
